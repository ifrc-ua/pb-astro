...
// Тексти степ-карток. Наразі взяті зі статті («Як голосують», «Смартфон і жива
// черга»), але збіг не обовʼязковий — про регістр цих текстів див. SceneShell.
// Остання картка — лише кнопка вільного режиму.
const STEPS = [
  "На перші дні кампанії припадає основна хвиля голосування, а на останні — крихти. <strong>Перші три дні кампанії дають до 40% голосів</strong>, останні три — лише 9–18%.",
