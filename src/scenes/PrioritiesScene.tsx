...
// Тексти степ-карток. Частина взята зі статті («Як мінялися правила», «Що
// виграє», «Війна наскрізно»), картка шва 2022 — своя: говорить про те, що в
// цей момент видно на графіку (падіння товщини потоку), її числа — з
// by_year_category цього ж priorities.json. Збіг із прозою не обовʼязковий —
// про регістр цих текстів див. SceneShell.
const STEPS = [
  ...
  "Перерву 2022-го видно і в товщині потоку: до неї подавали <strong>272 проєкти за рік</strong>, після — <strong>129</strong>, менш ніж половину. Рекорд 2020-го, 303 проєкти, не перевищено й досі.",
  "У 2025 році місто запровадило окрему категорію «Допомога ЗСУ» — поза звичайним голосуванням. Уже наступного, 2026 року, вона повернулася в конкурс на загальних засадах.",
];
