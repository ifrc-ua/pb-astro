...
Репозиторій змішаний, тому ліцензії різні для різних частин. [LICENSE](LICENSE)
покриває код; усе, що має інші умови, розписано в [NOTICE.md](NOTICE.md).
...
| Текст статті (`src/content/article/`) | усі права застережені — [NOTICE.md](NOTICE.md) |
| Шрифти, вендорені бібліотеки | треті сторони — [NOTICE.md](NOTICE.md) |
...
> `npm run check-numbers` звіряє числа статті з текстом-каноном і потребує
> сусіднього репозиторія `../pb-kurs`. Без нього скрипт виходить із поясненням,
> що саме клонувати.
