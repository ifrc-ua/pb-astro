...
export default defineConfig({
  // Базова адреса сайту — потрібна, щоб теги соцмереж (Open Graph) отримали
  // ПОВНІ посилання на картинку/сторінку (Astro.site + new URL(...) у layout).
  site: 'https://pb.ifrc.org.ua',
